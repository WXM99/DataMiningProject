...
def get_brand():
    word_file = open('../market_analysis/statistic_result/hd_brand.txt', 'r')
    res = list()
    for word in word_file.readlines():
...
def compute_value(brandname, weights):
...
def main():
    ...
    for i in items:
        ...
        print("score", compute_value(i, weights))

# main()
# compute_vector()
# get_sentence("samsung smh1816s 1.8 cu. ft. stainless steel over-the-range hairdryer")
main()